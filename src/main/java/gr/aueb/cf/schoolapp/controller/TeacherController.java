...
public class TeacherController {
    ...
    @PostMapping("/insert")
    public String teacherInsert(@Valid @ModelAttribute("teacherInsertDTO") TeacherInsertDTO teacherInsertDTO, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes){
    ...
    @GetMapping({"", "/"})
    public String getPaginatesTeachers(@PageableDefault(page = 0, size = 5, sort = "lastname") Pageable pageable
    , Model model){
...
//                new TeacherReadOnlyDTO
//                        ("ab123","Pavlos","Pavlopoulos","1234", "Athens"),
//                new TeacherReadOnlyDTO
//                        ("ab124","Nikos","Charos","1234", "Athens"),
//                new TeacherReadOnlyDTO
//                        ("ab125","Kostas","Lazaris","1234", "Athens"),
//                new TeacherReadOnlyDTO
//                        ("ab126","George","Petrou","1234", "Athens"),
//                new TeacherReadOnlyDTO
//                        ("ab127","Lydia","Spiropoulou","1234", "Athens"))
